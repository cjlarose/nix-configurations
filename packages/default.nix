...

{
  ...
  go_1_24 = nixpkgs-unstable.legacyPackages.${system}.go_1_24;
  go_1_26 = nixpkgs-unstable.legacyPackages.${system}.go_1_26;
  jira-cli-go = nixpkgs-unstable.legacyPackages.${system}.jira-cli-go;
